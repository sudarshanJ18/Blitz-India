      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
          ...
          <div className="space-y-4">
            <h2 className="text-4xl font-bold bg-gradient-to-r px-2 py-2 from-orange-600 to-orange-700 bg-clip-text text-transparent">
          ...
          <div className="flex flex-col md:items-end space-y-4">
            <div className="flex flex-wrap gap-6">
              <Link 
                to="/privacy-policy" 
                className="group relative px-6 py-3 bg-white hover:bg-gray-50 rounded-lg transition-all duration-300 border border-gray-300 hover:border-orange-500 shadow-sm hover:shadow-md"
              >
