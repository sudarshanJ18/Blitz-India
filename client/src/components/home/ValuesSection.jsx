...
const ValuesSection = () => {
  const valuesData = [
    {
      title: "Excellence",
      description: "Engineering excellence in every project, delivering solutions that exceed client expectations.",
      header: (
        <div className="relative flex flex-1 w-full h-full min-h-[6rem] rounded-xl overflow-hidden">
          ...
          <div className="absolute bottom-2 left-3 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-lg">
            <span className="text-xs font-semibold text-gray-900">Quality First</span>
          </div>
        </div>
      ),
    ...
    {
      title: "Innovation",
      description: "Cutting-edge technologies & innovative approaches to solve complex engineering challenges.",
      header: (
        <div className="relative flex flex-1 w-full h-full min-h-[6rem] rounded-xl overflow-hidden">
          <div 
            className="absolute inset-0 bg-cover bg-center"
          ...
          <div className="absolute bottom-2 left-3 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-lg">
            <span className="text-xs font-semibold text-gray-900">Future Ready</span>
          </div>
        </div>
      ),
    ...
    {
      title: "Collaboration",
      description: "Closely with our clients as partners, ensuring transparent communication and shared success.",
      header: (
        <div className="relative flex flex-1 w-full h-full min-h-[6rem] rounded-xl overflow-hidden">
          <div 
            className="absolute inset-0 bg-cover bg-center"
          ...
          <div className="absolute bottom-2 left-3 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-lg">
            <span className="text-xs font-semibold text-gray-900">Team Work</span>
          </div>
        </div>
      ),
    ...
    {
      title: "Integrity",
      description: "Highest standards of professional integrity, honesty, and ethical conduct in all our dealings.",
      header: (
        <div className="relative flex flex-1 w-full h-full min-h-[6rem] rounded-xl overflow-hidden">
          <div 
            className="absolute inset-0 bg-cover bg-center"
    ...
    },
    {
      ...
      description: "Success is our priority - delivering solutions that drive real business value and results.",
      header: (
        <div className="relative flex flex-1 w-full h-full min-h-[6rem] rounded-xl overflow-hidden">
          <div 
            className="absolute inset-0 bg-cover bg-center"
      ...
      icon: <IconArrowWaveRightUp className="h-6 w-6 text-orange-600" />,
    },
  ];
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-white via-gray-50 to-orange-50/30 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
        <div className="mb-12">
          <p className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-left">
            Core Values
          </p>
        </div>
