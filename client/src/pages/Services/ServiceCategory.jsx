...
import { categoryImages } from '../../assets/assets.js';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const categoryServices = allServices.filter(s => s.categoryId === Number(categoryId));
          ...
          <div className="relative">
            ...
            <div className="mt-8 md:absolute md:mt-0 md:top-32 lg:top-0 md:right-0">
              <img
                ...
                src={heroImages[category.categoryId]}
              ...
              >
                ...
                <div className="relative p-6 flex flex-col flex-grow z-10">
                  ...
                  <p className="text-gray-600 mb-6 flex-grow line-clamp-3 leading-relaxed">
                    {truncateDescription(service.description || service.shortDescription)}
                  </p>
